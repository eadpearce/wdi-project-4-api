...
class PromptsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create prompt" do
    assert_difference('Prompt.count') do
      post prompts_url, params: { prompt: { body: @prompt.body, title: @prompt.title, user_id: @prompt.user_id } }, as: :json
    end
  ...
  test "should update prompt" do
    patch prompt_url(@prompt), params: { prompt: { body: @prompt.body, title: @prompt.title, user_id: @prompt.user_id } }, as: :json
    assert_response 200
  end
